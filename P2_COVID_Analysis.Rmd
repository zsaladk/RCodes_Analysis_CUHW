---
title: "From Global Trends to Local Predictions: Analyzing COVID-19 Data"
output: html_document
date: "2026-01-22"
author: "KZH"

## https://github.com/zsaladk/RCodes_Analysis_CUHW/blob/main/P2_COVID_Analysis.Rmd
---
...
The aim of this report is to track how the COVID-19 pandemic shifted geographically from 2020 through 2022. By using maps to visualize data at three key points in time, I explore the relationship between case numbers and total deaths. The report is structured in two parts: first, a "big picture" look at global trends, followed by a detailed "zoom-in" on the United States. This analysis concludes with a predictive model designed to help policymakers anticipate mortality trends based on rising case counts.To ensure a responsible interpretation of the data, the report explicitly addresses potential biases, including differences in state-level testing access and reporting protocols.
...
### Examine Relationship between Cases and Deaths
### Develop Models to Predict Deaths from Covid19
...
```{r Create Model and Plot to predict deaths from cases,warning=FALSE}
## Modeling data
mod <-lm(deaths_per_thou ~ cases_per_thou, data=US_state_totals)

summary(mod)

## check min and max to determine the grid range.
